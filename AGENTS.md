...
- `docs/specs/assignment-10-context-strategies.md` - context-management strategy comparison spec.
...
- `docs/agent-notes/llm-demo-assignment-10.md` - Day 10 context strategy implementation decisions and checks.
...
- Day 10 context-strategy rules live in `docs/specs/assignment-10-context-strategies.md` and `docs/agent-notes/llm-demo-assignment-10.md`.
