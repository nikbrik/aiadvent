...
- `specs/assignment-10-context-strategies.md` - context-management strategy comparison requirements.
...
- `agent-notes/llm-demo-assignment-10.md` - Day 10 context strategy implementation notes.
